    ...
    public class PaymentsController : Controller
    {
        ...
        public ActionResult<string> GetPaymentLink([FromBody] Guid orderId)
        {
            ...
            else
            {
                ...
                products = orderItems.Select(orderItem => (orderItem.ProductId.ToString(), orderItem.OrderItem.Amount, (int)(_productRepository.GetProduct(orderItem.ProductId)!.Price!.Amount * 100))).Distinct().ToList();
            }
